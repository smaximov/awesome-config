...
beautiful.init("/home/nameless/.config/awesome/themes/zenburn/theme.lua")

-- This is used later as the default terminal and editor to run.
terminal = "gnome-terminal"

-- FIXME: configure emacs to run as a daemon;
--        therefore, EDITOR should be emacsclient.
...
menubar.utils.terminalsy = terminal -- Set the terminal for applications that require it
-- }}}
...
awful.rules.rules = {
    ...
    { rule = { class = "gimp" },
      properties = { floating = true } },
    -- Display Firefox on 'web' and 'd+w'
    { rule = { class = "Firefox" },
      properties = { tags = { tags[1][2], tags[1][4] } } },
